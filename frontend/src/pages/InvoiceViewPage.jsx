...
// --- CSS ---
// Ensure the updated CSS is imported globally or directly
...
const InvoiceViewPage = () => {
    ...
    const amountInWords = useMemo(() => {
        ...
        // Using placeholder for now, as requested.
    ...
    return (
        <div className="invoice-view-wrapper bg-light py-4 py-md-5">
            <Container>
                 ...
                 {/*
                   * =========================================================================
                   * INVOICE PAPER - PRINTABLE SECTION
                   * The 'printable-section' class is the key. The CSS uses it to isolate
                   * this div for printing, hiding all other elements on the page.
                   * =========================================================================
                 */}
                 <div className="invoice-paper printable-section mx-lg-auto p-4 p-md-5 border bg-white shadow-sm">
                        {/* --- Header --- */}
